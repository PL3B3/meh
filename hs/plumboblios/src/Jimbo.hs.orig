...
intsc :: (Num b, Fractional b) => [Snap] -> [(String, (String -> Bool))] -> [(String, (String -> Bool))] -> b
intsc sL evt cnd = portionTrueMulti sL (evt ++ cnd)


union :: (Num b, Fractional b) => [Snap] -> [(String, (String -> Bool))] -> [(String, (String -> Bool))] -> b
union sL evt cnd = (sum $ map (portionTrueMulti sL) [evt, cnd]) - (intsc sL evt cnd)
...
=======
>>>>>>> 401b9592c562cf274b500a30e6fa186c9bc0f299
